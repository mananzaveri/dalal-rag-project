...
def create_vectorstore(chunks: List[Document], embedding_model: HuggingFaceEmbeddings, persist_dir: str = None) -> Chroma:
    ...
    Args:
        ...
        persist_dir: Directory to persist the vector store (defaults to ./vectorstore in the app directory)
    ...
    if persist_dir is None:
        ...
        app_dir = os.path.dirname(current_dir)  # dalal-rag-project/rag_app/app
        persist_dir = os.path.join(app_dir, "vectorstore")
